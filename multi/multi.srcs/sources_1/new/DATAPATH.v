...
module DATAPATH(
    input clk,
    //mux
    input IorD,reg_dist,mem_to_reg,alu_srca,
...
MUX2_1 #(5) MUX_6(instr[20:16],instr[15:11],reg_dist,w6_8);
MUX2_1 MUX_7(w17_18,data,mem_to_reg,write_data_reg);
...
// BRANCH_SELECT BRANCH_19(zero,less,beq,bne,bgtz,blez,bgez,bltz,pc_src)
endmodule